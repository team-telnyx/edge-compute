/**
 * Telnyx MCP Server — JavaScript Edge Function
 *
 * A Model Context Protocol (MCP) server that exposes Telnyx API tools to AI
 * agents via streamable HTTP transport.  Agents can execute code against the
 * Telnyx SDK and search the SDK documentation.
 *
