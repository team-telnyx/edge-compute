...
| Tool | Description |
|------|-------------|
| `execute` | Write and run code against the Telnyx SDK |
...
│  Express + telnyx-mcp   │
│  ┌───────────────────┐  │
│  │ execute           │  │  Runs code against Telnyx SDK
...
```
index.js          # Entry point — imports telnyx-mcp, adds health probes, starts server
